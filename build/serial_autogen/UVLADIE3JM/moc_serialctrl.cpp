...
QT_MOC_LITERAL(6, 37, 3) // "tip"

    },
    "SerialCtrl\0response\0\0s\0error\0timeout\0"
    "tip"
};
...
void SerialCtrl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->timeout((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->tip((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SerialCtrl::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialCtrl::response)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialCtrl::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialCtrl::error)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SerialCtrl::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialCtrl::timeout)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (SerialCtrl::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialCtrl::tip)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject SerialCtrl::staticMetaObject = {
...
// SIGNAL 0
void SerialCtrl::response(QString _t1)
{
...
// SIGNAL 1
void SerialCtrl::error(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void SerialCtrl::timeout(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void SerialCtrl::tip(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
